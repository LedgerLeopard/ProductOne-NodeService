...
// const web3URL = `ws://localhost:${BLOCKCHAIN_WS_PORT}`;
// const web3httpURL = `https://localhost:${BLOCKCHAIN_PORT}`;
const web3blocks = new Web3('ws://13.94.201.26:8546');
const web3txs = new Web3('ws://13.94.201.26:8546');
const web3http = new Web3('http://13.94.201.26:9045');
const logger = require('../utils/logger');
const fs = require('fs');
const configFile = fs.readFileSync('/init', 'utf8');
const yaml = require('js-yaml');
const networkName = 'TrxExTest';
const vmName = 'TestExplorer6';
